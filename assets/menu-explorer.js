...
(() => {
  ...
  let state=null,owner=null,busy=false,generation=0,selected={},selectionDay=null;
  ...
  function render(animate=false){
    ...
    number.replaceChildren();number.hidden=!state.items.length;
