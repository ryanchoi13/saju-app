...
export function shoeDrawing(name,gender,fill){
 ...
 if(name==='샌들'){
  if(female)return p('M23 177 Q64 184 111 172 Q151 159 177 165 L177 174 Q148 174 115 183 Q65 197 26 188 Q19 186 23 177 Z',sole)
   ...
   +l('M150 136 L155 134 L157 140 L152 142 Z');
  ...
  return p('M18 176 Q67 186 116 175 L178 163 L183 180 Q129 199 31 193 Q15 191 18 176 Z',sole)
   ...
   +l('M51 166 L99 166 M112 156 L164 153 M25 183 Q90 195 180 172');
 }
