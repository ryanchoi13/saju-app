...
(() => {
  ...
  window.startDalhaDesignSample = () => {
    ...
    const v2Item=(category,label,color_name,hex,applied_daily_color)=>({category,label,color_name,hex,applied_daily_color});
    const v2Look=(tpo,look_role,items)=>({id:`female-autumn-${tpo}-${look_role}`,gender:'female',season:'autumn',tpo,look_role,items});
    const fashionV2={
      casual:{status:'ui_connected_stage3',looks:[
        v2Look('casual','daily',[v2Item('outer','블루종','베이지','#C4B294'),v2Item('top','긴팔 티셔츠','아이보리','#E8E0CF','A'),v2Item('bottom','스트레이트 청바지','데님 블루','#466889','B'),v2Item('shoes','레트로 운동화','그레이','#85888D')]),
        v2Look('casual','trend',[v2Item('mid','가디건','더스티 핑크','#B67C87','A'),v2Item('top','긴팔 티셔츠','아이보리','#E8E0CF'),v2Item('bottom','플리츠 스커트','네이비','#26354A','B'),v2Item('shoes','앵클부츠','블랙','#252629')])]},
      business_casual:{status:'ui_connected_stage3',looks:[
        v2Look('business_casual','daily',[v2Item('outer','블레이저','네이비','#26354A','B'),v2Item('top','크루넥 니트','더스티 핑크','#B67C87','A'),v2Item('bottom','슬랙스','그레이','#85888D'),v2Item('shoes','로퍼','다크 브라운','#4B352B')]),
        v2Look('business_casual','trend',[v2Item('mid','가디건','더스티 핑크','#B67C87','A'),v2Item('top','셔츠','화이트','#F5F4EF'),v2Item('bottom','우븐 스커트','네이비','#26354A','B'),v2Item('shoes','플랫','블랙','#252629')])]},
      business_formal:{status:'ui_connected_stage3',looks:[
        v2Look('business_formal','daily',[v2Item('outer','수트 재킷','네이비','#26354A','B'),v2Item('top','블라우스','페일 핑크','#DEC1C4','A'),v2Item('bottom','수트 바지','네이비','#26354A','B'),v2Item('shoes','펌프스','블랙','#252629')]),
        v2Look('business_formal','trend',[v2Item('outer','정장 재킷','차콜','#44474D'),v2Item('dress','정장 원피스','더스티 핑크','#B67C87','A'),v2Item('shoes','플랫','블랙','#252629')])]}
    };
