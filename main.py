...
# 4단계 모드 (대길 45%, 평온 30%, 신중 15%, 충전 10%) 오늘운세 생성기
...
# 12간지 동물별 & 12별자리 전용 정밀 일진 엔진 (모든 띠/별자리 개별 분기 및 매일 갱신)
@app.get("/api/zodiac-fortune")
def get_zodiac_fortune(type: str, key: str):
    today = datetime.date.today()
    today_ord = today.toordinal()
    
    # 띠/별자리 고유 해시와 날짜를 결합한 시드 -> 매일 12개 띠와 12개 별자리가 각각 다르게 갱신
    ...
    if type == "star":
        ...
        zodiac_profiles = {
            "쥐": {
                "trait": "기민한 재치와 풍부한 지혜", "match": "소띠, 용띠, 원숭이띠",
                "years": ["2008년생 (만 18세)", "1996년생 (만 30세)", "1984년생 (만 42세)", "1972년생 (만 54세)", "1960년생 (만 66세)"],
                "tips_pool": [
                    ["학업과 자격 취득에서 두각을 나타냅니다.", "새로운 기회 앞에서 주저하지 마세요.", "재물 흐름이 원활해지고 투자가 성과를 냅니다.", "동료와의 협력으로 오랜 난제를 해결합니다.", "무리한 투자 대신 내실을 다질 때 안전합니다."],
                    ["순발력 있는 판단이 칭찬을 부릅니다.", "이직이나 승진 제안을 신중히 검토하세요.", "작은 지출 관리에 신경 써야 할 타이밍입니다.", "가정의 평안과 건강을 최우선으로 챙기세요.", "경험과 지혜를 후배들에게 아낌없이 전하세요."]
                ]
            },
            "소": {
                "trait": "우직한 성실함과 두터운 신뢰", "match": "쥐띠, 뱀띠, 닭띠",
                "years": ["2009년생 (만 17세)", "1997년생 (만 29세)", "1985년생 (만 41세)", "1973년생 (만 53세)", "1961년생 (만 65세)"],
                "tips_pool": [
                    ["꾸준한 노력이 성적 향상으로 이어집니다.", "기본에 충실할 때 경쟁자를 압도합니다.", "책임감 있는 모습이 승진과 계약을 부릅니다.", "부동산이나 장기 자산에서 길운이 따릅니다.", "무리한 야외활동을 피하고 휴식을 취하세요."],
                    ["차분한 태도가 실수를 완벽히 방어합니다.", "새로운 인연과의 신뢰가 깊어지는 날입니다.", "서두르지 말고 계획대로 밀고 나가세요.", "가족과의 대화에서 뜻밖의 해결책을 얻습니다.", "지나친 고집을 내려놓고 유연함을 가지세요."]
                ]
            },
            "호랑이": {
                "trait": "당당한 용기와 거침없는 기상", "match": "말띠, 개띠, 돼지띠",
                "years": ["2010년생 (만 16세)", "1998년생 (만 28세)", "1986년생 (만 40세)", "1974년생 (만 52세)", "1962년생 (만 64세)"],
                "tips_pool": [
                    ["자신감 넘치는 발표가 큰 호응을 얻습니다.", "도전적인 프로젝트에서 리더십을 발휘하세요.", "과감한 결단이 정체된 물꼬를 시원하게 틉니다.", "사업상 중요한 귀인을 만나 협력하게 됩니다.", "마음의 여유를 가질 때 건강운이 살아납니다."],
                    ["체력 관리에 힘쓰고 루틴을 정돈하세요.", "이성운이 상승하여 매력이 돋보이는 하루입니다.", "독단적인 판단보다 팀원들의 조언을 구하세요.", "명예와 성과가 세상에 널리 알려집니다.", "원칙을 지키며 유연하게 대처할 때 대길합니다."]
                ]
            },
            "토끼": {
                "trait": "섬세한 감각과 평화로운 조화", "match": "양띠, 개띠, 돼지띠",
                "years": ["2011년생 (만 15세)", "1999년생 (만 27세)", "1987년생 (만 39세)", "1975년생 (만 51세)", "1963년생 (만 63세)"],
                "tips_pool": [
                    ["창의적인 아이디어가 돋보이는 하루입니다.", "대인관계에서 온화한 매너가 빛을 발합니다.", "세심한 서류 검토가 손실을 미연에 방지합니다.", "파트너십을 통해 상생의 결실을 거둡니다.", "무리한 약속을 줄이고 집에서 편히 쉬세요."],
                    ["친구와의 깊은 대화가 큰 위로가 됩니다.", "취업이나 이직 준비에 길한 정보가 들어옵니다.", "감정적인 소비를 피하고 지갑을 잠그세요.", "가정 내의 서운한 감정을 부드럽게 푸세요.", "평온한 명상이나 산책으로 기운을 북돋우세요."]
                ]
            },
            "용": {
                "trait": "웅장한 포부와 변화를 이끄는 힘", "match": "쥐띠, 원숭이띠, 닭띠",
                "years": ["2000년생 (만 26세)", "1988년생 (만 38세)", "1976년생 (만 50세)", "1964년생 (만 62세)", "1952년생 (만 74세)"],
                "tips_pool": [
                    ["새로운 무대로 나아갈 절호의 기회입니다.", "아이디어를 실행에 옮길 강력한 에너지가 찹니다.", "사업적 확장의 결실이 가시화되는 길일입니다.", "권위와 명예가 서고 주변의 존경을 받습니다.", "무리한 과로를 경계하고 건강을 살피세요."],
                    ["당신의 능력을 알아주는 멘토를 만납니다.", "투자와 계약에서 신중하게 실리를 챙기세요.", "주변 사람들과의 성과 나눔이 복을 부릅니다.", "오랜 숙원 사업이 순조롭게 매듭지어집니다.", "차분한 마음가짐이 평생의 덕을 쌓습니다."]
                ]
            },
            "뱀": {
                "trait": "예리한 통찰력과 치밀한 지략", "match": "소띠, 원숭이띠, 닭띠",
                "years": ["2001년생 (만 25세)", "1989년생 (만 37세)", "1977년생 (만 49세)", "1965년생 (만 61세)", "1953년생 (만 73세)"],
                "tips_pool": [
                    ["직관이 뛰어나 문제의 핵심을 짚어냅니다.", "물밑 협상에서 결정적인 우위를 점합니다.", "재테크와 투자에서 날카로운 안목을 발휘합니다.", "조직 내 갈등을 지혜롭게 중재하게 됩니다.", "충분한 수면으로 뇌의 피로를 풀어주세요."],
                    ["자기계발에 투자하기 가장 좋은 타이밍입니다.", "겉으로 드러내지 않고 내실을 다질 때 길합니다.", "비밀스러운 계획을 차분히 구체화하세요.", "문서운이 좋아 계약 체결에 매우 유리합니다.", "여유로운 미소가 대인관계를 부드럽게 합니다."]
                ]
            },
            "말": {
                "trait": "역동적인 추진력과 밝은 활력", "match": "호랑이띠, 양띠, 개띠",
                "years": ["2002년생 (만 24세)", "1990년생 (만 36세)", "1978년생 (만 48세)", "1966년생 (만 60세)", "1954년생 (만 72세)"],
                "tips_pool": [
                    ["에너지가 넘치니 활동 반경을 넓히세요.", "빠른 실행력이 경쟁에서 승리를 이끕니다.", "영업과 미팅에서 괄목할 성과를 거둡니다.", "자산 회전이 빨라지고 숨통이 트입니다.", "운전이나 보행 시 서두르지 말고 조심하세요."],
                    ["새로운 스포츠나 취미를 시작하기 길합니다.", "주변에 긍정의 기운을 전파하는 리더가 됩니다.", "무리한 지출을 삼가고 실속을 챙기세요.", "오랜 지인으로부터 기쁜 소식을 듣습니다.", "자연과 함께하는 힐링이 보약이 됩니다."]
                ]
            },
            "양": {
                "trait": "온화한 배려심과 예술적 품격", "match": "토끼띠, 말띠, 돼지띠",
                "years": ["2003년생 (만 23세)", "1991년생 (만 35세)", "1979년생 (만 47세)", "1967년생 (만 59세)", "1955년생 (만 71세)"],
                "tips_pool": [
                    ["따뜻한 배려가 좋은 인연을 끌어당깁니다.", "팀워크를 발휘할 때 더 큰 시너지가 납니다.", "인간관계의 오해가 풀리고 화합을 이룹니다.", "안정적인 계약과 합의가 원만히 성사됩니다.", "따뜻한 차 한잔으로 마음의 안정을 찾으세요."],
                    ["예술적 감각이 돋보여 칭찬을 받습니다.", "직장에서 묵묵히 해온 노력을 인정받습니다.", "급한 결정보다 한 템포 쉬어감이 유리합니다.", "가족들과의 오붓한 식사가 큰 힘이 됩니다.", "지나친 걱정을 내려놓고 평안을 누리세요."]
                ]
            },
            "원숭이": {
                "trait": "다재다능한 재치와 뛰어난 임기응변", "match": "쥐띠, 용띠, 뱀띠",
                "years": ["2004년생 (만 22세)", "1992년생 (만 34세)", "1980년생 (만 46세)", "1968년생 (만 58세)", "1956년생 (만 70세)"],
                "tips_pool": [
                    ["재치 있는 입담이 분위기를 주도합니다.", "난관에 부딪혀도 번뜩이는 묘수를 찾습니다.", "멀티태스킹 능력이 극대화되는 하루입니다.", "새로운 판로를 개척하거나 투자를 유치합니다.", "가벼운 스트레칭으로 관절 건강을 챙기세요."],
                    ["친구들과의 교류에서 뜻밖의 힌트를 얻습니다.", "기획안이나 보고서 작성이 막힘없이 풀립니다.", "경솔한 언행을 조심하면 완벽한 하루가 됩니다.", "사업상 유익한 파트너를 만나게 됩니다.", "지혜로운 처세로 주변의 부러움을 삽니다."]
                ]
            },
            "닭": {
                "trait": "단정한 원칙과 명확한 결단력", "match": "소띠, 용띠, 뱀띠",
                "years": ["2005년생 (만 21세)", "1993년생 (만 33세)", "1981년생 (만 45세)", "1969년생 (만 57세)", "1957년생 (만 69세)"],
                "tips_pool": [
                    ["시간 약속과 원칙을 지키면 신뢰가 배가됩니다.", "전문성을 인정받아 중요한 책임을 맡습니다.", "금전 관리가 철저하여 손실을 완벽히 막습니다.", "시험, 자격증, 승진에서 낭보가 따릅니다.", "과도한 긴장을 풀고 여유를 가지세요."],
                    ["꼼꼼한 준비가 완벽한 결과를 만듭니다.", "깔끔한 스타일링이 인기를 부르는 날입니다.", "날카로운 비판보다 따뜻한 조언을 건네세요.", "자산 증식의 탄탄한 발판을 마련합니다.", "정돈된 환경에서 최고의 집중력이 나옵니다."]
                ]
            },
            "개": {
                "trait": "진실된 의리와 굳건한 충직함", "match": "호랑이띠, 토끼띠, 말띠",
                "years": ["2006년생 (만 20세)", "1994년생 (만 32세)", "1982년생 (만 44세)", "1970년생 (만 56세)", "1958년생 (만 68세)"],
                "tips_pool": [
                    ["신의를 지키는 태도가 귀인을 부릅니다.", "오랜 친구나 동료와의 유대가 단단해집니다.", "믿고 맡긴 일에서 기대 이상의 성과를 냅니다.", "주변 사람들을 챙길 때 복이 배로 돌아옵니다.", "충분한 휴식으로 컨디션을 조절하세요."],
                    ["솔직하고 투명한 소통이 오해를 풉니다.", "직장에서 신뢰받는 든든한 버팀목이 됩니다.", "공적인 일과 사적인 감정을 구분하세요.", "가정에 경사가 생기고 웃음꽃이 핍니다.", "안정된 마음가짐이 재물운을 지켜줍니다."]
                ]
            },
            "돼지": {
                "trait": "너그러운 포용력과 타고난 복록", "match": "호랑이띠, 토끼띠, 양띠",
                "years": ["2007년생 (만 19세)", "1995년생 (만 31세)", "1983년생 (만 43세)", "1971년생 (만 55세)", "1959년생 (만 67세)"],
                "tips_pool": [
                    ["마음이 넉넉하니 주변에 사람들이 모입니다.", "음식 복과 대인 복이 함께 들어오는 날입니다.", "양보하고 베푼 배려가 큰 이득으로 돌아옵니다.", "순조로운 자금 융통으로 근심이 사라집니다.", "가벼운 유산소 운동으로 활력을 유지하세요."],
                    ["밝은 미소가 모든 액운을 물리칩니다.", "오랜 노력이 드디어 값진 결실을 맺습니다.", "충동구매를 자제하고 실속을 챙기세요.", "화목한 가정 분위기 속에서 평안을 얻습니다.", "마음먹은 일을 차분히 실행하기 길합니다."]
                ]
            }
        }
        
        prof = zodiac_profiles.get(key, zodiac_profiles["말"])
        tips_list = rng.choice(prof["tips_pool"])
        
        tips = [
            {"year_label": prof["years"][i], "tip": tips_list[i]}
            for i in range(len(prof["years"]))
        ]
        
        times_pool = ["오전 09시 ~ 11시", "오전 11시 ~ 오후 01시", "오후 01시 ~ 03시", "오후 03시 ~ 05시", "오후 05시 ~ 07시"]
        lucky_time_str = rng.choice(times_pool)
        score = rng.randint(86, 99)

        overviews_pool = [
            f"오늘의 일진 기운이 {prof['trait']}과 상생하여, 추진하는 일마다 귀인의 도움을 받아 시원하게 풀리는 길일입니다.",
            f"{prof['trait']}을 온전히 발휘할 수 있는 환경이 조성됩니다. 매사 자신감을 가지고 당당하게 임하세요.",
            f"주변과의 화합과 신뢰가 돋보이는 날입니다. 작은 양보와 미소가 더 큰 행운과 결실로 돌아옵니다."
        ]

        return {
            "name": f"{key}띠",
            "score": score,
            "title": f"{today.strftime('%m월 %d일')} {key}띠 오늘의 정밀 일진",
            "overview": rng.choice(overviews_pool),
            "lucky_time": lucky_time_str,
            "lucky_match": f"찰떡궁합: {prof['match']}",
            "year_tips": tips
        }
