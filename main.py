...
app = FastAPI(title="운세의 신 정통 명리학 엔진 - Clean Edition", version="42.0.0")
        ...
        <div style="display: flex; flex-direction: column; gap: 16px; font-size: 14.5px; color: #334155; line-height: 1.85; text-align: left;">
            ...
            <div>
                ...
                <div style="display: flex; flex-direction: column; gap: 8px; font-size: 14px; color: #1E40AF; line-height: 1.8;">
                    <p>• <strong>타고난 지적 역량:</strong> 한번 파고든 학문과 기술의 끝을 보는 '문창성(文昌星)'의 지혜를 타고났습니다. 벼락치기보다는 3~6개월의 꾸준한 루틴을 세울 때 시험 합격률이 98%에 달합니다.</p>
                    <p>• <strong>국가공인/전문 자격증 합격운:</strong> 부동산, 금융, 법률, 기술 전문 자격 취득 및 공공기관/승진 시험에서 강력한 문서운(印星)이 발동하여 높은 점수로 합격증을 거머쥡니다.</p>
                </div>
            </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 16px; font-size: 14.5px; color: #334155; line-height: 1.85; text-align: left;">
            <div>
                ...
                <p style="color: #7F1D1D; line-height: 1.85; margin-bottom: 12px;">
                    2026년은 강렬한 불(火)의 기운이 어둠을 걷어내고 대지를 환하게 비추는 丙午년입니다. {user_name}님의 명식과 조화를 이루어 그동안 준비해 온 역량이 화려하게 꽃을 피우며 막혀 있던 활로가 시원하게 뚫리는 <strong>'비상(飛翔)의 한 해'</strong>가 됩니다. 집안에 경사(자녀의 진학/취업, 부모님 건강 회복, 가문 합동 행사)가 깃들어 가족 간의 결속이 한층 두터워집니다.
                </p>
            </div>
...
def get_theme_report(req: dict):
    ...
    if theme == "wealth":
        ...
        if sub_opt == "취업/이직":
            ...
            """
        elif sub_opt == "시험/자격/승진":
            b_ch1 = "🎓 [시험·자격·승진 합격] 단기 합격률 200% 비결 & 관운 집중기"
            b_desc1 = f"""
            <p>• <strong>시험 합격 골든타임:</strong> 관성(官星)과 인성(印星)이 합을 이루는 상반기(양력 4~6월)와 가을(양력 9~11월)에 시험을 치를 때 찍은 문제도 정답이 되는 강력한 합격운이 따릅니다.</p>
            <p>• <strong>합격 공부 전략:</strong> 방대한 양을 무작정 암기하기보다 기출문제 중심의 핵심 20%를 반복 회독할 때 단기 고득점을 완성합니다.</p>
            """
            b_ch2 = "📖 집중력 극대화 풍수 & 슬럼프 극복 루틴"
            b_desc2 = f"""
            <p>책상을 북동쪽이나 정북쪽에 배치하고 조명을 은은한 주백색으로 맞추세요. 수면 시간을 6시간 이상 규칙적으로 확보할 때 두뇌 회전이 2배 빨라집니다.</p>
            """
        else: # 직장인
