...
app = FastAPI(title="운세의 신 PRO API", version="3.6.0")
    ...
    return {
        ...
        <div style="display: flex; flex-direction: column; gap: 14px; font-size: 12px; color: #334155; line-height: 1.6; text-align: left;">
            ...
            <div style="background: #F8FAFC; border: 1px solid #E2E8F0; border-radius: 16px; padding: 14px;">
                ...
                <div style="display: flex; flex-direction: column; gap: 8px; font-size: 11px;">
                    <div style="background: #FFFFFF; border: 1px solid #E2E8F0; border-radius: 12px; padding: 10px;">
                        <p style="font-weight: 700; color: #0F172A;">🌱 [유년기 (년주 기반 / 0세 ~ 19세) : 기틀 형성 및 학업기]</p>
                        <p style="color: #475569; margin-top: 2px;">탐구심과 지적 호기심이 왕성했던 시기로, 다재다능한 감각을 기르며 내면의 뼈대를 공고히 하던 유년기입니다. 인성(印星)의 조력을 받아 학업 및 기초 소양 구축에 유익했던 기반 형성기입니다.</p>
                    </div>
                    <div style="background: #FFFFFF; border: 1px solid #E2E8F0; border-radius: 12px; padding: 10px;">
                        <p style="font-weight: 700; color: #0F172A;">🌿 [청년기 (월주 기반 / 20세 ~ 39세) : 도약과 실전 탐색기]</p>
                        <p style="color: #475569; margin-top: 2px;">사회로 진출하여 다양한 시행착오와 도전을 통해 자신만의 전문 역량을 갈고닦던 시기입니다. 시련 속에서도 결단력과 추진력을 길러 중년의 큰 성공을 위한 튼튼한 발판을 마련했습니다.</p>
                    </div>
                    <div style="background: #FEF3C7; border: 1px solid #FCD34D; border-radius: 12px; padding: 10px;">
                        <p style="font-weight: 800; color: #78350F;">🔥 [중장년기 (*현재 40세 ~ 59세) : 황금 비상 및 자산 결실기]</p>
                        <p style="color: #92400E; margin-top: 2px;"><strong>{user_name}님 사주 인생의 최고 하이라이트 구간입니다.</strong> 일주(日柱)의 천을귀인과 유금(酉金) 편재가 왕성하게 결합하여, 사회적 주도권을 완전히 잡고 커리어 상승과 자산 확장이 거침없이 일어나는 황금 비상기입니다.</p>
                    </div>
                    <div style="background: #FFFFFF; border: 1px solid #E2E8F0; border-radius: 12px; padding: 10px;">
                        <p style="font-weight: 700; color: #0F172A;">🍎 [말년기 (시주 기반 / 60세 이후) : 태평성대 및 완숙기]</p>
                        <p style="color: #475569; margin-top: 2px;">평생 축적한 지혜와 부를 바탕으로 명예로운 노후를 완성하는 시기입니다. 자손 복과 문서운이 풍족하여 안락하고 평온한 정토를 누리게 됩니다.</p>
                    </div>
                </div>
            </div>
            ...
            <div style="background: #FFFBEB; border: 1px solid #FDE68A; border-radius: 16px; padding: 14px;">
                ...
                <div style="background: #FFFFFF; border: 1px solid #FDE68A; border-radius: 12px; padding: 10px; font-size: 11px; color: #78350F;">
                    <p style="font-weight: 700;">💡 대운 성공 조언 & 개운 실천 가이드:</p>
                    <p style="margin-top: 2px;">• 남의 말에 현혹된 위험한 투자를 경계하고, 본인이 직접 검증한 문서/시스템 자산에 집중하십시오.</p>
                    <p style="margin-top: 2px;">• 주중 수요일이나 목요일 오전에 서남쪽 방향에서 만나는 귀인과의 협상이 자산 증식의 큰 열쇠가 됩니다.</p>
                </div>
            </div>

            <!-- 3. 평생 귀인/상극 인연 & 종합 개운 비급 -->
            <div style="background: #ECFDF5; border: 1px solid #A7F3D0; border-radius: 16px; padding: 14px;">
                <h4 style="font-size: 13px; font-weight: 800; color: #065F46; border-bottom: 1px solid #A7F3D0; padding-bottom: 6px; margin-bottom: 10px;">
                    🤝 3. {user_name}님의 평생 귀인/상극 인연 & 종합 개운 비급
                </h4>
                <div style="margin-bottom: 8px;">
                    <p style="font-weight: 700; color: #065F46;">🌟 평생 나를 돕는 귀인: 쥐띠, 소띠, 뱀띠 (서북쪽 및 동남쪽 방향)</p>
                    <p style="font-size: 11px; color: #334155; margin-top: 2px;">감정적으로 흔들릴 때 차분하게 중심을 잡아주며, 법률, 세무, 대형 계약 등 결정적 순간에 실질적인 해결책을 안겨주는 평생의 동반자입니다.</p>
                </div>
                <div style="border-top: 1px solid #A7F3D0; padding-top: 8px; margin-bottom: 8px;">
                    <p style="font-weight: 700; color: #BE123C;">⚠️ 평생 주의해야 할 상극 인연: 호랑이띠, 토끼띠</p>
                    <p style="font-size: 11px; color: #334155; margin-top: 2px;">성향이 지나치게 강해 사소한 의견 차이로도 자존심 싸움이 번질 수 있습니다. 금전 거래나 동업 시 반드시 공증과 서면 계약을 철저히 하십시오.</p>
                </div>
                <div style="border-top: 1px solid #A7F3D0; padding-top: 8px; font-size: 11px;">
                    <p style="font-weight: 700; color: #065F46;">🎨 오행 체질 맞춤 개운 비급 (색상/방향/음식):</p>
                    <p style="margin-top: 2px;">• <strong>행운의 색상:</strong> 아이보리, 스카이 블루, 황금색 계열 의상 및 소품 추천.</p>
                    <p style="margin-top: 2px;">• <strong>개운 음식:</strong> 미온수, 검은콩, 견과류, 신선한 야채 중심 식단으로 수(水)기운 보강.</p>
                </div>
            </div>
        </div>
        """
        ...
        return {
            ...
            <div style="display: flex; flex-direction: column; gap: 12px; font-size: 12px; color: #334155; line-height: 1.6; text-align: left;">
                <div style="background: #FFFBEB; border: 1px solid #FDE68A; border-radius: 12px; padding: 12px;">
                    <p style="font-weight: 800; color: #78350F; font-size: 13px;">[재물 그릇의 본질] '금고형' 자산 축적 원국</p>
                    <p style="font-size: 11px; color: #92400E; margin-top: 2px;">일확천금의 위험한 투기보다 체계적인 시스템과 현금 흐름을 통해 복리로 부를 쌓아 올리는 대기만성형 황금 금고를 타고났습니다.</p>
                </div>
                <div>
                    <p style="font-weight: 700; color: #0F172A;">1. {user_name}님 맞춤 최적 자산 포트폴리오 전략</p>
                    <p style="font-size: 11px; color: #475569; margin-top: 2px;">변동성이 극심한 주식 단타나 코인 등 리스크가 높은 자산은 재물 유실을 유발하기 쉽습니다. 실물 부동산(상가, 토지, 안정적 주거 자산) 및 배당형 우량 자산에 전체 자산의 70% 이상을 배분할 때 손실 없이 안정적인 우상향 그래프를 그립니다.</p>
                </div>
                <div>
                    <p style="font-weight: 700; color: #0F172A;">2. 재물운이 폭발하는 인생 최고의 대박 타이밍</p>
                    <p style="font-size: 11px; color: #475569; margin-top: 2px;">40대 중후반과 50대 초반 구간에 강력한 문서운(印星/財星)이 연이어 들어옵니다. 이 시기에 계약한 계약서나 보유 부동산의 가치가 최소 2배 이상 수직 상승하는 퀀텀점프의 기회를 맞이하게 됩니다.</p>
                </div>
                <div>
                    <p style="font-weight: 700; color: #0F172A;">3. 손재수(損財數) 및 헛돈 방어 개운 비방</p>
                    <p style="font-size: 11px; color: #475569; margin-top: 2px;">지인이나 가까운 친족 간의 구두 금전 대여는 절대 금물입니다. 집 안이나 사무실의 서남쪽 방향에 황금빛 소품이나 금속 재질의 인테리어를 배치하고, 노란색 계열의 지갑을 사용할 때 새어나가는 재물의 기운을 완벽하게 차단할 수 있습니다.</p>
                </div>
            </div>
            """
        }
        ...
        return {
            ...
            <div style="display: flex; flex-direction: column; gap: 12px; font-size: 12px; color: #334155; line-height: 1.6; text-align: left;">
                <div style="background: #FFF1F2; border: 1px solid #FECDD3; border-radius: 12px; padding: 12px;">
                    <p style="font-weight: 800; color: #881337; font-size: 13px;">[현재 상태: {sub_opt}] 맞춤 애정 정밀 감명</p>
                    <p style="font-size: 11px; color: #9F1239; margin-top: 2px;">현재 {user_name}님의 기운은 내면의 깊은 신뢰와 유대감을 형성하기에 가장 안정적이고 온화한 상태입니다.</p>
                </div>
                <div>
                    <p style="font-weight: 700; color: #0F172A;">1. 나에게 운명적으로 맞는 평생 배필의 특징</p>
                    <p style="font-size: 11px; color: #475569; margin-top: 2px;">겉치레나 화려한 언변보다는 대화가 깊이 통하고 배려심이 깊으며, {user_name}님의 열정적이고 주도적인 성향을 묵묵히 품어주는 차분한 인품의 소유자와 가장 고품격 궁합을 이룹니다.</p>
                </div>
                <div>
                    <p style="font-weight: 700; color: #0F172A;">2. 시기별 애정 흐름 및 관계 발전 가이드</p>
                    <p style="font-size: 11px; color: #475569; margin-top: 2px;">상반기에는 서로의 가치관을 확인하며 소통의 깊이를 더하고, 하반기로 갈수록 두 사람 사이의 현실적 결속력(미래 설계, 공동 자산 관리, 안정적 결혼 생활)이 매우 단단해지는 대길의 흐름입니다.</p>
                </div>
                <div>
                    <p style="font-weight: 700; color: #0F172A;">3. 인연의 온도를 평생 유지하는 핵심 처세법</p>
                    <p style="font-size: 11px; color: #475569; margin-top: 2px;">서운한 감정이 생겼을 때는 즉각적으로 대립하기보다 하루의 여유를 두고 차분히 감정을 정리한 뒤 대화하는 것이 애정운의 불꽃을 평생 지키는 최고의 비결입니다.</p>
                </div>
            </div>
            """
        }
        ...
        return {
            ...
            <div style="display: flex; flex-direction: column; gap: 12px; font-size: 12px; color: #334155; line-height: 1.6; text-align: left;">
                <div style="background: #EFF6FF; border: 1px solid #BFDBFE; border-radius: 12px; padding: 12px;">
                    ...
                    <p style="font-size: 11px; color: #1E40AF; margin-top: 2px;">치밀한 기획력과 디테일한 실행력이 완벽히 결합되어 어떤 조직이나 분야에서든 핵심 수장으로 두각을 나타낼 사주 구조입니다.</p>
                </div>
                <div>
                    <p style="font-weight: 700; color: #0F172A;">1. 성공을 보장하는 대박 직무/사업 분야</p>
                    <p style="font-size: 11px; color: #475569; margin-top: 2px;">전문 컨설팅, IT/기술 기획, 유통 및 브랜드 매니지먼트, 자산 관리, 인재 개발 등 체계적인 시스템을 구축하고 사람과 자원을 연결하는 영역에서 귀하의 능력이 최고 가치로 환산됩니다.</p>
                </div>
                <div>
                    <p style="font-weight: 700; color: #0F172A;">2. 승진/이직/창업 성공의 최적 타이밍</p>
                    <p style="font-size: 11px; color: #475569; margin-top: 2px;">가을과 겨울로 넘어가는 환절기 구간에 나를 강력히 끌어주는 결정적 귀인(상사, 거대 파트너사)이 등장합니다. 이 시기 추진하는 신규 사업이나 이직은 성공 확률이 3배 이상 높아집니다.</p>
                </div>
                <div>
                    <p style="font-weight: 700; color: #0F172A;">3. 사업적 성공을 완성하는 리더십 지침</p>
                    <p style="font-size: 11px; color: #475569; margin-top: 2px;">모든 실무를 본인이 직접 도맡으려 하지 말고, 검증된 신뢰할 수 있는 파트너에게 과감하게 역할을 위임하고 전체 판을 조율할 때 성과의 규모가 비약적으로 확장됩니다.</p>
                </div>
            </div>
            """
        }
        ...
        return {
            ...
            <div style="display: flex; flex-direction: column; gap: 12px; font-size: 12px; color: #334155; line-height: 1.6; text-align: left;">
                <div style="background: #ECFDF5; border: 1px solid #A7F3D0; border-radius: 12px; padding: 12px;">
                    <p style="font-weight: 800; color: #065F46; font-size: 13px;">[오행 체질 진단] 화(火)·토(土) 왕성 체질</p>
                    <p style="font-size: 11px; color: #047857; margin-top: 2px;">대사 활동과 생명력은 매우 왕성하나, 상대적으로 수(水)와 금(金) 기운이 빠르게 소모될 수 있는 체질적 특성을 지녔습니다.</p>
                </div>
                <div>
                    <p style="font-weight: 700; color: #0F172A;">1. 평생 집중 관리해야 할 취약 장기</p>
                    <p style="font-size: 11px; color: #475569; margin-top: 2px;">심혈관계의 과도한 열기를 조절하고, 신장, 방광, 관절 및 호흡기 계통의 수분을 충분히 보충하는 생활 습관이 평생 장수와 활력의 핵심 열쇠입니다.</p>
                </div>
                <div>
                    <p style="font-weight: 700; color: #0F172A;">2. 체질을 다스리는 맞춤 섭생 가이드</p>
                    <p style="font-size: 11px; color: #475569; margin-top: 2px;">자극적이고 과도하게 매운 음식이나 차가운 음료는 피하십시오. 검은깨, 검은콩, 해조류, 미온수 등 신장 기능을 보강하는 블랙푸드를 식단에 적극 곁들이는 것이 좋습니다.</p>
                </div>
                <div>
                    <p style="font-weight: 700; color: #0F172A;">3. 100세 건강을 완성하는 일상 개운 루틴</p>
                    <p style="font-size: 11px; color: #475569; margin-top: 2px;">매일 취침 전 10분간의 따뜻한 족욕이나 가벼운 명상을 통해 머리의 상기된 열을 발끝으로 내리는 수승화강(水昇火降) 루틴을 실천하면 수면의 질이 획기적으로 개선됩니다.</p>
                </div>
            </div>
            """
        }
